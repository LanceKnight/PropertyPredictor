...
train_loader = DataLoader(ToxCast[:train_num], batch_size = batch_size, shuffle = True)
validate_loader = DataLoader(ToxCast[train_num:train_num+val_num], batch_size = batch_size, shuffle = False)
test_loader = DataLoader(ToxCast[-test_num:], batch_size = batch_size, shuffle = False)

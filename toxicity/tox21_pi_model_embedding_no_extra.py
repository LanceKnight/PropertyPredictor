# pi model with more unlabeled data. Output embedding for PCA
import torch
...
for col in target_col:
	...
	for epoch in tqdm(range(num_epoches)):
		...
		train(train_loader, epoch==(num_epoches-1), col, unsupervised_weight)#epoch==(num_epoches-1))
